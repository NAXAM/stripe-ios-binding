...
SWIFT_CLASS("_TtC6Stripe23STPBankAccountCollector")
@interface STPBankAccountCollector : NSObject
/// By default <code>sharedHandler</code> initializes with STPAPIClient.shared.
@property (nonatomic, strong) STPAPIClient * _Nonnull apiClient;
- (nonnull instancetype)init;
- (nonnull instancetype)initWithAPIClient:(STPAPIClient * _Nonnull)apiClient;
...
SWIFT_CLASS("_TtC6Stripe27STPCollectBankAccountParams")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC6Stripe30STPConfirmUSBankAccountOptions")
...
@interface STPConfirmUSBankAccountOptions (SWIFT_EXTENSION(Stripe)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (UIImage * _Nonnull)afterpayLogoWithLocale:(NSLocale * _Nonnull)locale SWIFT_WARN_UNUSED_RESULT;
/// This returns the appropriate icon for the affirm logo
+ (UIImage * _Nonnull)affirmLogo SWIFT_WARN_UNUSED_RESULT;
...
/// Contains details describing microdeposits verification flow for US Bank Accounts.
SWIFT_CLASS("_TtC6Stripe38STPIntentActionVerifyWithMicrodeposits")
...
@interface STPIntentActionVerifyWithMicrodeposits (SWIFT_EXTENSION(Stripe)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC6Stripe17STPPaymentHandler")
...
@interface STPPaymentHandler (SWIFT_EXTENSION(Stripe)) <SFSafariViewControllerDelegate>
/// :nodoc:
...
/// seealso:
/// <TODO>
SWIFT_CLASS("_TtC6Stripe22STPPaymentMethodAffirm")
...
SWIFT_CLASS("_TtC6Stripe28STPPaymentMethodAffirmParams")
...
/// An unknown type.
  STPPaymentMethodTypeUnknown = 27,
};
...
SWIFT_CLASS("_TtC6Stripe29STPPaymentMethodUSBankAccount")
...
@interface STPPaymentMethodUSBankAccount (SWIFT_EXTENSION(Stripe)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Contains information about US bank account networks that can be used
SWIFT_CLASS("_TtC6Stripe37STPPaymentMethodUSBankAccountNetworks")
...
SWIFT_CLASS("_TtC6Stripe35STPPaymentMethodUSBankAccountParams")
...
@interface STPPaymentMethodUSBankAccountParams (SWIFT_EXTENSION(Stripe)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
